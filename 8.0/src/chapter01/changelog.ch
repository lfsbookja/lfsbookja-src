...
@y
      ...
      <itemizedlist>
        ...
        <listitem>
          <para>[ken] - 特定のマシンにて coreutils, findutils, gettext の test-lock テストが無限ループとなるためコメントアウト。</para>
        </listitem>
      </itemizedlist>
@z
...
@y
      ...
      <itemizedlist>
        <listitem>
          <para>[bdubbs] - shadow のアップストリームが行っているバグフィックスを (埋め込みのパッチの形で) 追加。</para>
        </listitem>
      </itemizedlist>
@z

@x
      <para>2017-02-13</para>
      <itemizedlist>
        <listitem>
          <para>[bdubbs] - Update to file-5.30.  Fixes
          <ulink url="&lfs-ticket-root;4047">#4047</ulink>.</para>
        </listitem>
      </itemizedlist>
@y
      <para>2017-02-13</para>
      <itemizedlist>
        <listitem>
          <para>[bdubbs] - file-5.30 へのアップデート。
          <ulink url="&lfs-ticket-root;4047">#4047</ulink> を Fix に。</para>
        </listitem>
      </itemizedlist>
@z

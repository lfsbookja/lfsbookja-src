...
@y
      ...
      <itemizedlist>
        <listitem>
          <para>[xry111] - pkgconf-2.1.0 の機能縮退に対するアップストリーム修正を適用。
          <ulink url='&lfs-ticket-root;5414'>#5414</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[xry111] - jinja2-3.1.3 (セキュリティフィックス) へのアップデート。
          <ulink url='&lfs-ticket-root;5411'>#5411</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[xry111] - bc-6.7.5 へのアップデート。
          <ulink url='&lfs-ticket-root;5408'>#5408</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[xry111] - attr-2.5.2 へのアップデート。
          <ulink url='&lfs-ticket-root;5412'>#5412</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[xry111] - ncurses-6.4-20230520 (セキュリティフィックス) へのアップデート。
          Fixes <ulink url='&lfs-ticket-root;5416'>#5416</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[xry111] - markupsafe-2.1.4 へのアップデート。
          <ulink url='&lfs-ticket-root;5418'>#5418</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[xry111] - linux-6.7.1 へのアップデート。
          <ulink url='&lfs-ticket-root;5406'>#5406</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[xry111] - iproute2-6.7.0 へのアップデート。
          <ulink url='&lfs-ticket-root;5410'>#5410</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[xry111] - vim-9.1.0041 へのアップデート。
          <ulink url='&lfs-ticket-root;4500'>#4500</ulink> にて言及。</para>
        </listitem>
        <listitem>
          <para>[xry111] - iana-etc-20240117 へのアップデート。
          <ulink url='&lfs-ticket-root;5006'>#5006</ulink> にて言及。</para>
        </listitem>
        <listitem>
          <para>[xry111] - shadow-4.14.3 へのアップデート。
          <ulink url='&lfs-ticket-root;5413'>#5413</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[xry111] - coreutils-9.4 における CVE-2024-0684 を修正。
          <ulink url="&lfs-ticket-root;5417">#5417</ulink> を Fix に。</para>
        </listitem>
      </itemizedlist>
@z
...
@y
      ...
      <itemizedlist>
        <listitem>
          <para>[xry111] - ncurses ヘッダーを修正し、libncursesw.so を用いてワイドキャラクター ABI が常に用いられるようにする。
          これによって 8 ビットの libncurses.so とするため。
          <ulink url="&lfs-ticket-root;5415">#5415</ulink> を Fix に。</para>
        </listitem>
      </itemizedlist>
@z

...
@y
  <para>
  本書は Linux From Scratch ブック、バージョン &version;<phrase arch="ml_32,ml_x32,ml_all">-multilib</phrase>、&releasedate; 公開です。
...
@y
      ...
      <itemizedlist>
        <listitem>
          <para>[thomas] - systemd の手順を修正。
          パッチを準備してくれた Eric Clothier に感謝。</para>
        </listitem>
      </itemizedlist>
@z
...
@y
      ...
      <itemizedlist>
        ...
        <listitem>
          <para>[bdubbs] - Python-3.13.1 へのアップデート (セキュリティアップデ
ート)。
...
@y
      ...
      <itemizedlist>
        ...
        <listitem>
          <para>[bdubbs] - setuptools-75.6.0 (Python モジュール) へのアップデー
ト。
...
@x
      ...
      <itemizedlist>
        <listitem>
          <para>[thomas] - Upgrade to isl-0.27.</para>
        </listitem>
      </itemizedlist>
@y
      <para>2024-11-18</para>
      <itemizedlist>
        <listitem>
          <para>[thomas] - isl-0.27 へのアップグレード。</para>
        </listitem>
      </itemizedlist>
@z
...
@y
      ...
      <itemizedlist>
        ...
        <listitem>
          <para>[bdubbs] - setuptools-75.5.0 (Python モジュール) へのアップデー
ト。

...
@y
      ...
      <itemizedlist>
        <listitem>
          <para>[bdubbs] - LFS-11.0-rc3 リリース。</para>
        </listitem>
        <listitem>
          <para>[bdubbs] - e2fsprogs-1.46.4 へのアップデート。
          <ulink url="&lfs-ticket-root;4910">#4910</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[bdubbs] - meson-0.59.1 へのアップデート。
          <ulink url="&lfs-ticket-root;4909">#4909</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[bdubbs] - util-linux 2.37.2 へのアップデート。
          <ulink url="&lfs-ticket-root;4908">#4908</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[bdubbs] - linux-5.13.12 へのアップデート。
          <ulink url="&lfs-ticket-root;4907">#4907</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[bdubbs] - libcap-2.53 へのアップデート。
          <ulink url="&lfs-ticket-root;4906">#4906</ulink> を Fix に。</para>
        </listitem>
        <listitem>

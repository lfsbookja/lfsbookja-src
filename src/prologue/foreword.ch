...
@y
<para>
私が Linux について学び始め理解するようになったのは 1998 年頃からです。
...
最終ゴールが同じものなのに、それを実現する方法はたくさんあるものです。
...
それが Linux になって "選ぶ" という考え方が出てきました。
何かが気に入らなかったら、いくらでも変えたら良いし、そうすることがむしろ当たり前となったのです。
</para>
@z
...
ただこれは正しいとか間違っているとかの問題ではなく、個人的な趣味の問題へと変化しています。
こうしたさまざまな状況を通じて明らかになってきたのは、私にとって完璧なシステムは１つもないということです。
そして私は自分自身の Linux を作り出して、自分の好みを満足させるものを目指しました。
</para>
@z
...
さらに個々のソフトウェアまでも自分で作り出せれば、もっと楽しいものになるのでしょうが、それは次の目標とします。
</para>
@z
...
壮大なこの意欲こそが <emphasis>Linux From Scratch プロジェクト</emphasis>誕生の理由です。 
</para>
@z
...
そうしたとしても手順を踏み外すものではありません。
我々は皆さんが旅に挑戦することを応援します。
</para>
@z

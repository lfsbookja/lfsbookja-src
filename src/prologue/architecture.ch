...
@y
<para>
LFS が対象としている CPU アーキテクチャーは、主に AMD/Intel x86_64 CPU (64ビット) です。
本書の手順は SSE2 サポートを持つ 32 ビット x86 CPU (たとえば Pentium4) などに対しても動作します。
ただしそれよりも低機能の 32 ビット x86 プロセッサーはテストしていません。
一方で本書の手順を多少修正すれば Power PC や ARM においても動作します。

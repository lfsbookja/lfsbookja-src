...
@y
      packaging モジュールは、相互運用性を実装したユーティリティーを提供する Python ライブラリです。
      これを通じて明確で唯一の動作を規定 (PEP440) したり、共有的な実装 (PEP425) を採用することでそのメリットを最大限活用したりします。
      ここには、バージョンの取り扱い、識別子、マーカー、タグなどを取り扱うユーティリティーが含まれます。
@z

@x
    <title>Installation of Packaging</title>
@y
    <title>&InstallationOf1;Packaging&InstallationOf2;</title>
@z
...
@y
    <title>&ContentsOf1;Packaging&ContentsOf2;</title>
@z

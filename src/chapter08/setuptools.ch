...
@y
    <para>Setuptools は Python パッケージに対してのダウンロード、ビルド、インストール、アンインストール、アップグレードを行うツールです。
    </para>
@z
...
@y
    <title>&InstallationOf1;Setuptools&InstallationOf2;</title>
@z
...
@y
    <title>&ContentsOf1;Setuptools&ContentsOf2;</title>
@z
...
@y
            /usr/lib/python&python-minor;/site-packages/_distutils_hack,
            /usr/lib/python&python-minor;/site-packages/pkg_resources,
            /usr/lib/python&python-minor;/site-packages/setuptools,
            /usr/lib/python&python-minor;/site-packages/setuptools-&setuptools-version;.dist-info
@z

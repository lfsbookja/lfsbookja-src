...
@y
    <title>&IntroductionTo1;nepomuk-widgets&IntroductionTo2;</title>
@z
...
@y
    <para>
    Nepomuk-widgets は Nepomuk Semantik デスクトップに対してのウィジェットライブラリを提供します。
    </para>
@z
...
@y
        <para>&DownloadSize;: &nepomuk-widgets-size;</para>
@z

@x
        <para>Estimated disk space required: &nepomuk-widgets-buildsize;</para>
@y
        <para>&Estimateddiskspacerequired;: &nepomuk-widgets-buildsize;</para>
@z

@x
        <para>Estimated build time: &nepomuk-widgets-time;</para>
@y
        <para>&Estimatedbuildtime;: &nepomuk-widgets-time;</para>
@z

@x
    <bridgehead renderas="sect3">Nepomuk-widgets Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;Nepomuk-widgets&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;nepomuk-widgets&InstallationOf2;</title>
@z
...
@y
    <para>
    以下のコマンドを実行して <application>nepomuk-widgets</application> をビルドします。
    </para>
@z

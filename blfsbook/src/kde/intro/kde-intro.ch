...
@y
  <para>
  <application>KDE</application> Software Compilation 4 は、分かりやすいデスクトップ環境であり、これに対応した数多くのアプリケーションが提供され、数多くのユーザーも抱えています。
...
@y
  <para>
  <application>KDE</application> のコアパッケージの順番は、推奨する順であり、テストした順で示しています。
  <application>KDE</application> の追加パッケージは、どのような順でビルドしても構いません。
  </para>
@z

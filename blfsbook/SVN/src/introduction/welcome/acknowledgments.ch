...
@y
      <para>
      Robert Briggs には、&lfs-domainname; と linuxfromscratch.com のドメイン名を提供して頂きました。
      </para>
@z
...
@x
      <para><ulink url="mailto:strider@linux.com">Mark Stone</ulink>
      &lt;mstone &lt;at&gt; linux.com&gt; for donating the original
      &lfs-domainname; servers.</para>
@y
      <para><ulink url="mailto:strider@linux.com">Mark Stone</ulink>
      &lt;mstone &lt;at&gt; linux.com&gt; for donating the original
      &lfs-domainname; servers.</para>

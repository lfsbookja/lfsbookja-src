...
@y
    <title>Phonon Xine backend の概要</title>
@z
...
@y
    <para>
    このパッケージは <application>Xine</application> メディアフレームワークを利用する、<application>Phonon</application> のバックエンドライブラリを提供します。
    </para>
@z
...
@y
        <para>ダウンロード (HTTP): <ulink url="&phonon-backend-xine-download-http;"/></para>
@z

@x
        <para>Download (FTP): <ulink url="&phonon-backend-xine-download-ftp;"/></para>
@y
        <para>ダウンロード (FTP): <ulink url="&phonon-backend-xine-download-ftp;"/></para>
@z

@x
        <para>Download MD5 sum: &phonon-backend-xine-md5sum;</para>
@y
        <para>ダウンロード MD5 sum: &phonon-backend-xine-md5sum;</para>
@z

@x
        <para>Download size: &phonon-backend-xine-size;</para>
@y
        <para>ダウンロードサイズ: &phonon-backend-xine-size;</para>
@z

@x
        <para>Estimated disk space required: &phonon-backend-xine-buildsize;</para>
@y
        <para>&j-Estimateddiskspacerequired;: &phonon-backend-xine-buildsize;</para>
@z

@x
        <para>Estimated build time: &phonon-backend-xine-time;</para>
@y
        <para>&j-Estimatedbuildtime;: &phonon-backend-xine-time;</para>
@z
...
@y
    <title>Phonon Backend Xine のインストール</title>
@z
...
@y
    <para>
    以下のコマンドを実行して <application>Phonon Backend Xine</application> をビルドします。
    </para>
@z

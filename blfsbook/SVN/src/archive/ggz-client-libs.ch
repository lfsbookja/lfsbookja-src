...
@y
    <title>&IntroductionTo1;ggz-client-libs&IntroductionTo2;</title>
@z
...
@y
        <para>&DownloadSize;: &ggz-client-libs-size;</para>
@z

@x
        <para>Estimated disk space required: &ggz-client-libs-buildsize;</para>
@y
        <para>&Estimateddiskspacerequired;: &ggz-client-libs-buildsize;</para>
@z

@x
        <para>Estimated build time: &ggz-client-libs-time;</para>
@y
        <para>&Estimatedbuildtime;: &ggz-client-libs-time;</para>
@z

@x
    <bridgehead renderas="sect3">ggz-client-libs Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;ggz-client-libs&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;ggz-client-libs&InstallationOf2;</title>
@z

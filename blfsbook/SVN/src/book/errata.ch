...
@y
<sect1 id="errata" xreflabel="正誤情報">
  <?dbhtml filename="errata.html"?>
@z
...
@y
  <para>
  BLFS にて構築するアプリケーションソフトウェア類は常に更新され拡張されています。
  BLFS ブックが公開された後には、セキュリティフィックスやバグフィックスが提供されているかもしれません。
  本バージョンの BLFS ブックにて、作業するパッケージのバージョンや作業手順において、セキュリティフィックス、バグフィックスが必要かどうかはビルド前に <ulink
  url="&errata;"/> を確認してください。

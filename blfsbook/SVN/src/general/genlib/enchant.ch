...
@y
<para>
<application>enchant</application>
パッケージは、スペルチェックを行うさまざまなライブラリへの汎用的なインターフェースを提供します。
</para>
@z
...
@y
        <para>ダウンロード (HTTP): <ulink url="&enchant-download-http;"/></para>
@z

@x
        <para>Download (FTP): <ulink url="&enchant-download-ftp;"/></para>
@y
        <para>ダウンロード (FTP): <ulink url="&enchant-download-ftp;"/></para>
@z

@x
        <para>Download MD5 sum: &enchant-md5sum;</para>
@y
        <para>ダウンロード MD5 sum: &enchant-md5sum;</para>
@z

@x
        <para>Download size: &enchant-size;</para>
@y
        <para>ダウンロードサイズ: &enchant-size;</para>
@z

@x
        <para>Estimated disk space required: &enchant-buildsize;</para>
@y
        <para>&j-Estimateddiskspacerequired;: &enchant-buildsize;</para>
@z

@x
        <para>Estimated build time: &enchant-time;</para>
@y
        <para>&j-Estimatedbuildtime;: &enchant-time;</para>
@z

@x
    <bridgehead renderas="sect3">enchant Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">enchant の依存パッケージ</bridgehead>
@z

...
@y
<para>
<application>libgnome-keyring</application>
パッケージは、各ユーザーのパスワードなどの情報を保持するプログラムを提供します。
...
@y
        <para>ダウンロード (HTTP): <ulink url="&libgnome-keyring-download-http;"/></para>
@z

@x
        <para>Download (FTP): <ulink url="&libgnome-keyring-download-ftp;"/></para>
@y
        <para>ダウンロード (FTP): <ulink url="&libgnome-keyring-download-ftp;"/></para>
@z

@x
        <para>Download MD5 sum: &libgnome-keyring-md5sum;</para>
@y
        <para>ダウンロード MD5 sum: &libgnome-keyring-md5sum;</para>
@z

@x
        <para>Download size: &libgnome-keyring-size;</para>
@y
        <para>ダウンロードサイズ: &libgnome-keyring-size;</para>
@z
...
Keyring システムと連動したアプリケーションにおいて利用されます。
</para>
@z

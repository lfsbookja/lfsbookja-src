...
@y
    <para>
    <application>Kdeartwork</application> は <application>KDE</application> においての追加のテーマ、スクリーンセーバー、サウンド、壁紙、ウィジェットスタイル、ウィンドウスタイルを提供します。
    </para>
@z
...
@y
    <para><application>kdeartwork</application> をビルドします。</para>
@z

...
@y
  <!ENTITY kde-base-artwork-time          "&LessThan1;0.1 SBU&LessThan2;">
@z

@x
    <title>Introduction to Kde-base-artwork</title>
@y
    <title>&IntroductionTo1;Kde-base-artwork&IntroductionTo2;</title>
@z
...
@y
    <para>
    本パッケージは KDE におけるデフォルトのスプラッシュ画面を提供します。
    </para>
@z
...
@y
        <para>&DownloadSize;: &kde-base-artwork-size;</para>
@z

@x
        <para>Estimated disk space required: &kde-base-artwork-buildsize;</para>
@y
        <para>&Estimateddiskspacerequired;: &kde-base-artwork-buildsize;</para>
@z

@x
        <para>Estimated build time: &kde-base-artwork-time;</para>
@y
        <para>&Estimatedbuildtime;: &kde-base-artwork-time;</para>
@z

@x
    <bridgehead renderas="sect3">Kde-base-artwork Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;Kde-base-artwork&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;Kde-base-artwork&InstallationOf2;</title>
@z
...
@y
    <para>
    以下のコマンドを実行して <application>Kde-base-artwork</application> をビルドします。
    </para>
@z

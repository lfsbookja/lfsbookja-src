...
@y
  <para>
  本章では独立したプロジェクトとして、特定の目的によりインストールするプログラムを説明します。
  Together, they create a respectable
  office suite. While they may be lacking in user interface consistency,
  they excel in doing one thing and doing it well.
  </para>
@z

...
@y
<para>
本書のこれ以降で実行するコマンドはすべて <systemitem class="username">root</systemitem>
ユーザーでログインして実行します。
もう <systemitem class="username">lfs</systemitem> ユーザーは不要です。
<systemitem class="username">root</systemitem>
ユーザーの環境にて環境変数 <envar>$LFS</envar>
...
ディレクトリの所有者は今は <systemitem class="username">lfs</systemitem>
ユーザーであり、これはホストシステム上に存在するユーザーです。
この <filename class="directory">$LFS/tools</filename>
...
<systemitem class="username">lfs</systemitem> ユーザーを作成することが考えられます。
その場合には同一のユーザーID、グループIDとなるように作ります。
もっと良い方法があります。
<filename class="directory">$LFS/tools</filename>
ディレクトリの所有者を <systemitem class="username">root</systemitem>
...
<para>
<filename class="directory">$LFS/tools</filename>
ディレクトリは LFS システムの構築作業を終えれば削除することができます。
一方これを残しておいて <emphasis>本書と同一バージョンの </emphasis>
LFS システムを新たに構築する際に利用することもできます。
<filename class="directory">$LFS/tools</filename>
...
@y
<para>
この先の LFS システム構築に向けて一時的なツール類を残しておきたい場合は <emphasis>この時点で </emphasis>

...
@x
      <para><ulink url="mailto:renodr@linuxfromscratch.org">Douglas Reno</ulink>
...
@y
  <bridgehead renderas="sect2">翻訳者</bridgehead>
@z
...
@y
      <para><ulink url="mailto:macana@macana-es.com">Manuel Canales
      Esparcia</ulink> &lt;macana@macana-es.com&gt; &ndash;
      スペインの LFS 翻訳プロジェクト</para>
@z
...
@y
      <para><ulink url="mailto:info@linuxfromscratch.org.ru">Anton Maisak</ulink> 
      &lt;info@linuxfromscratch.org.ru&gt; &ndash; ロシアの LFS
      翻訳プロジェクト</para>
@z
...
@y
      <para><ulink url="mailto:helen@linuxfromscratch.org.ru">Elena Shevcova</ulink> 
      &lt;helen@linuxfromscratch.org.ru&gt; &ndash; ロシアの LFS
      翻訳プロジェクト</para>
@z
...
@y
  <bridgehead renderas="sect3">北米のミラー</bridgehead>
@z
...
@y
      <para><ulink url="mailto:scott@osuosl.org">Scott Kveton</ulink>
      &lt;scott@osuosl.org&gt; &ndash; lfs.oregonstate.edu ミラー</para>
@z
...
@y
      <para><ulink url="mailto:lost@l-w.net">William Astle</ulink>
      &lt;lost@l-w.net&gt; &ndash; ca.linuxfromscratch.org ミラー</para>
@z
...
@y
      <para><ulink url="mailto:eujon.sellers@gmail.com">Eujon Sellers</ulink>
      &lt;jpolen@rackspace.com&gt; &ndash; lfs.introspeed.com ミラー</para>
@z
...
@y
  <bridgehead renderas="sect3">南米のミラー</bridgehead>
@z
...
@y
      <para><ulink url="mailto:manuel@linuxfromscratch.org">Manuel
      Canales Esparcia</ulink> &lt;manuel@linuxfromscratch.org&gt; &ndash;
      lfsmirror.lfs-es.info ミラー</para>
@z
...
@y
      <para><ulink url="mailto:lfalcon@thymbra.com">Luis Falcon</ulink>
      &lt;Luis Falcon&gt; &ndash; torredehanoi.org ミラー</para>
@z

@x
  <bridgehead renderas="sect3">European Mirrors</bridgehead>
@y
  <bridgehead renderas="sect3">ヨーロッパのミラー</bridgehead>
@z
...
@y
      <para><ulink url="mailto:guido@primerelay.net">Guido Passet</ulink>
      &lt;guido@primerelay.net&gt; &ndash; nl.linuxfromscratch.org ミラー</para>
@z
...
@y
      <para><ulink url="mailto:baafie@planet.nl">Bastiaan Jacques</ulink>
      &lt;baafie@planet.nl&gt; &ndash; lfs.pagefault.net ミラー</para>
@z
...
@y
      <para><ulink url="mailto:sven.cranshoff@lineo.be">Sven Cranshoff</ulink>
      &lt;sven.cranshoff@lineo.be&gt; &ndash; lfs.lineo.be ミラー</para>
@z

@x
      <para>Scarlet Belgium &ndash; lfs.scarlet.be mirror</para>
@y
      <para>Scarlet Belgium &ndash; lfs.scarlet.be ミラー</para>
@z
...
@y
      <para><ulink url="mailto:info@aliensoft.org">Sebastian Faulborn</ulink>
      &lt;info@aliensoft.org&gt; &ndash; lfs.aliensoft.org ミラー</para>
@z
...
@y
      <para><ulink url="mailto:stuart@dontuse.ms">Stuart Fox</ulink>
      &lt;stuart@dontuse.ms&gt; &ndash; lfs.dontuse.ms ミラー</para>
@z
...
@y
      <para><ulink url="mailto:admin@realhost.de">Ralf Uhlemann</ulink>
      &lt;admin@realhost.de&gt; &ndash; lfs.oss-mirror.org ミラー</para>
@z
...
@y
      <para><ulink url="mailto:Antonin.Sprinzl@tuwien.ac.at">Antonin
      Sprinzl</ulink> &lt;Antonin.Sprinzl@tuwien.ac.at&gt; &ndash;
      at.linuxfromscratch.org ミラー</para>
@z
...
@y
      <para><ulink url="mailto:fredan-lfs@fredan.org">Fredrik
      Danerklint</ulink> &lt;fredan-lfs@fredan.org&gt; &ndash;
      se.linuxfromscratch.org ミラー</para>
@z
...
@y
      <para><ulink url="mailto:franck@linuxpourtous.com">Franck</ulink>
      &lt;franck@linuxpourtous.com&gt; &ndash; lfs.linuxpourtous.com ミラー</para>
@z
...
@y
      <para><ulink url="mailto:gyouja@pilgrims.ru">Vitaly Chekasin</ulink>
      &lt;gyouja@pilgrims.ru&gt; &ndash; lfs.pilgrims.ru ミラー</para>
@z
...
@y
  <bridgehead renderas="sect3">アジアのミラー</bridgehead>
@z
...
@y
      <para><ulink url="mailto:satit@wbac.ac.th">Satit Phermsawang</ulink>
      &lt;satit@wbac.ac.th&gt; &ndash; lfs.phayoune.org ミラー</para>
@z
...
@y
      <para><ulink url="mailto:info@shizu-net.jp">Shizunet Co.,Ltd.</ulink>
      &lt;info@shizu-net.jp&gt; &ndash; lfs.mirror.shizu-net.jp ミラー</para>
@z
...
@y
      <para><ulink url="http://www.initworld.com/">Init World</ulink>
      &lt;http://www.initworld.com/&gt; &ndash; lfs.initworld.com ミラー</para>
@z

@x
  <bridgehead renderas="sect3">Australian Mirrors</bridgehead>
@y
  <bridgehead renderas="sect3">オーストラリアのミラー</bridgehead>
@z
...
@y
      <para><ulink url="mailto:jason@dstc.edu.au">Jason Andrade</ulink>
      &lt;jason@dstc.edu.au&gt; &ndash; au.linuxfromscratch.org ミラー</para>
@z

@x
  <bridgehead renderas="sect2">Former Project Team Members</bridgehead>
@y
  <bridgehead renderas="sect2">以前のプロジェクトチームメンバー</bridgehead>
@z
...
@y
      <para><ulink url="mailto:manuel@linuxfromscratch.org">Manuel
      Canales Esparcia</ulink> &lt;manuel@linuxfromscratch.org&gt; &ndash;
      LFS/BLFS/HLFS の XML と XSL の管理者</para>
@z
...
@y
    <listitem><para>Seth W. Klein &ndash; FAQ 管理者</para></listitem>
@z
...
@y
      <para><ulink url="mailto:nicholas@linuxfromscratch.org">Nicholas
      Leippe</ulink> &lt;nicholas@linuxfromscratch.org&gt; &ndash;
      Wiki 管理者</para>
@z
...
@y
      <para>Jesse Tie-Ten-Quee &ndash; LFS テクニカルライター</para>
@z

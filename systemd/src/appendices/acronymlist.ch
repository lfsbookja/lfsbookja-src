...
@y
        <para>アプリケーション バイナリ インターフェース (Application Binary Interface)</para>
@z
...
@y
        <para>アプリケーション プログラミング インターフェース (Application Programming Interface)</para>
@z
...
@y
        <para>ベーシック インプット/アウトプット システム; バイオス (Basic Input/Output System)</para>
@z
...
@y
        <para>ルートのチェンジ (change root)</para>
@z

@x CMOS
        <para>Complementary Metal Oxide Semiconductor</para>
@y
        <para>シーモス (Complementary Metal Oxide Semiconductor)</para>
@z
...
@y
        <para>中央演算処理装置 (Central Processing Unit)</para>
@z

@x CRC
        <para>Cyclic Redundancy Check</para>
@y
        <para>巡回冗長検査 (Cyclic Redundancy Check)</para>
@z

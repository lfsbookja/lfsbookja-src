...
@y
    <para>
    Expat パッケージは XML 解析するためのストリーム指向の (stream oriented) C ライブラリを提供します。
    </para>
@z
...
@y
    <para>ドキュメントが必要な場合はインストールします。</para>
@z
...
@y
          <para>
          XML ドキュメントが正しいかどうかをチェックするユーティリティー。
          </para>
@z

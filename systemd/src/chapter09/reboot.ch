...
@y
    <listitem><para>
    <ulink
    url='&blfs-root;/view/svn/basicnet/lynx.html'>Lynx</ulink> のようなテキストブラウザーをインストールしておけば、仮想端末からでも BLFS ブックを簡単に参照しながらパッケージビルド作業を進めることができます。
    </para></listitem>
@z
...
@y
    <listitem><para><ulink
    url='&blfs-root;/view/svn/general/gpm.html'>GPM</ulink> パッケージをインストールすれば、仮想端末内にてコピーペースト操作を行うことができます。
    </para></listitem>
@z
...
@y
    ...
    url='&blfs-root;/view/svn/basicnet/dhcpcd.html'>dhcpcd</ulink> パッケージや <ulink
    url='&blfs-root;/view/svn/basicnet/dhcp.html'>dhcp</ulink> パッケージのクライアントモジュール部分を利用することが考えられます。
    </para></listitem>
@z
...
@y
    <listitem><para><ulink
    url='&blfs-root;/view/svn/postlfs/sudo.html'>sudo</ulink> をインストールすれば、ルートユーザー以外であっても、パッケージビルドとインストールを容易に行うことができます。
    </para></listitem>
@z
...
@y
    ...
    url='&blfs-root;/view/svn/postlfs/openssh.html'>openssh</ulink> とその依存パッケージである <ulink
    url='&blfs-root;/view/svn/postlfs/openssl.html'>openssl</ulink> をインストールします。
    </para></listitem>
@z
...
@y
    ...
    url='&blfs-root;/view/svn/basicnet/wget.html'>wget</ulink> をインストールします。
    </para></listitem>
@z
...
@y
    ...
    url='&blfs-root;/view/svn/postlfs/gptfdisk.html'>gptfdisk</ulink> または <ulink
    url='&blfs-root;/view/svn/postlfs/parted.html'>parted</ulink> が有用なものとなります。
    </para></listitem>
@z

...
@y
    ...
    url="&faq-root;"/> に示されている「よく尋ねられる質問」(Frequently Asked Questions; FAQ) を参照してください。
    </para>
@z
...
@y
    <para>
    これ以外に、投稿の方法、アーカイブの配置場所などに関しては <ulink url="&lfs-root;mail.html"/> を参照してください。
    </para>
@z
...
@y
    ...
    IRC は <uri>irc.freenode.net</uri> において、チャネル名 #LFS-support により提供しています。
    </para>
@z
...
@y
    ...
    これらを使えばウェブサイト参照やパッケージのダウンロードがより便利に利用できます。

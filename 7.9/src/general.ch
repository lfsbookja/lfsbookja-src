...
@x
<!ENTITY version         "7.9">
<!ENTITY short-version   "7.9">  <!-- Used below in &blfs-book;. Change to x.y for release 
                                      but not -rc releases -->
<!ENTITY releasedate     "March 8, 2016">
@y
<?xml version="1.0" encoding="UTF-8"?>
<!ENTITY version         "7.9">
<!ENTITY short-version   "7.9">  <!-- Used below in &blfs-book;. Change to x.y for release 
                                      but not -rc releases -->
<!ENTITY releasedate     "2016年03月08日">
<!ENTITY jversion        "20160309">
@z

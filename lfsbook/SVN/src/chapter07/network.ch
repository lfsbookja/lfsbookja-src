...
例えば Intel 製と Realtek 製の二つのネットワークカードを持つコンピュータにおいて、
...
またドライバが検出できている場合には、カッコ書きでドライバ名も示されます。
ハードウェア ID もドライバ名も、インターフェースに対して与えられる名称とは無関係で、単に分かりやすくするために記されているにすぎません。

...
ファイルの内容に基づいて <filename>aclocal.m4</filename>
ファイルを生成します。
</para>
@z
...
@y
<para>
<filename>Makefile.am</filename> ファイルから
<filename>Makefile.in</filename> ファイルを自動生成するツール。
パッケージ内のすべての <filename>Makefile.in</filename>
ファイルを作るには、このプログラムをトップディレクトリから実行します。
<filename>configure.in</filename>
ファイルを調べて、適切な <filename>Makefile.am</filename>
ファイルを検索します。そして対応する <filename>Makefile.in</filename>
ファイルを生成します。
</para>
@z
...
@y
<para>
インストール中に GNU プログラムが存在しなかった場合に、共通のスタブ (stub)
プログラムとして動作するスクリプト。
</para>
@z
...
@y
<para>
<command>lex</command> と <command>yacc</command>
に対するラッパースクリプト。
</para>
@z

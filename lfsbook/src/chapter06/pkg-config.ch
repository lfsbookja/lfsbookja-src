...
@y
    ...
    外部よりインストールする Popt を用いる必要がある場合は、Pkg-config をインストールする前に BLFS の <ulink url="&blfs-root;view/svn/general/popt.html">Popt ビルド手順</ulink> を参考にしてインストールを行ってください。
    </para></note>
@z
...
@y
    <para>Pkg-config のテストにて発生する問題を解消します。</para>
@z

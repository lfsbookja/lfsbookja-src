...
-->
    ...
    <listitem>
      ...
      <itemizedlist>
        <listitem>
          <para>[matsuand] -
          SVN-20120204, <ulink url="&lfs-rev-root;9728">r9728</ulink> 対応。
          </para>
        </listitem>
      </itemizedlist>
    </listitem>
    ...
    <listitem>
      ...
      <itemizedlist>
        <listitem>
          <para>[matsuand] -
          SVN-20120202, <ulink url="&lfs-rev-root;9726">r9726</ulink> 対応。
          </para>
        </listitem>
      </itemizedlist>
    </listitem>
    ...
    <listitem>
      ...
      <itemizedlist>
        <listitem>
          <para>[matsuand] -
          SVN-20120201, <ulink url="&lfs-rev-root;9724">r9724</ulink> 対応。
          </para>
        </listitem>
      </itemizedlist>
    </listitem>
    ...
    <listitem>
      ...
      <itemizedlist>
        <listitem>
          <para>[matsuand] -
          SVN-20120130, <ulink url="&lfs-rev-root;9723">r9723</ulink> 対応。
          </para>
        </listitem>
      </itemizedlist>
    </listitem>
    ...
    <listitem>
      ...
      <itemizedlist>
        <listitem>
          <para>[matsuand] -
          SVN-20120128, <ulink url="&lfs-rev-root;9720">r9720</ulink> 対応。
          </para>
        </listitem>
      </itemizedlist>
    </listitem>
    ...
    <listitem>
      ...
      <itemizedlist>
        <listitem>
          <para>[matsuand] -
          SVN-20120126, <ulink url="&lfs-rev-root;9715">r9715</ulink> 対応。
          </para>
        </listitem>
      </itemizedlist>
    </listitem>

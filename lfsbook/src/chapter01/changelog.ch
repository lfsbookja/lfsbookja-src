...
@y
      ...
      <itemizedlist>
        <listitem>
          <para>[bdubbs] - less-530 へのアップデート。
          <ulink url="&lfs-ticket-root;4220">#4220</ulink> を Fix に。</para>
        </listitem>
        <listitem>
           <para>[bdubbs] - eudev のページにて LIBRARY_PATH と LD_LIBRARY_PATH の説明を追加。
          <ulink url="&lfs-ticket-root;4224">#4224</ulink> を Fix に。</para>
        </listitem>
        <listitem>
           <para>[bdubbs] - 32-ビットと 64-ビットシステムの双方を示す際には 64-ビットシステムの例を初めに示す。
          <ulink url="&lfs-ticket-root;4225">#4225</ulink> を Fix に。</para>
        </listitem>
      </itemizedlist>
@z

...
@y
<para>
ここでは --grub-setup=/bin/true を指定して、マスターブートレコード
...
を管理するサードパーティ製のブートマネージャーソフトウェアを利用している場合などがこれに該当します。
</para> 
@z
...
'linux' の設定行内にあるパラメーター 'root=' での設定内容とは異なります。

...
-->
    ...
    <listitem>
      ...
      <itemizedlist>
        <listitem>
          ...
          LFS-7.1,
          Changeset
          <ulink url="&lfs-rev-root;9759">9759</ulink>,
    ...
    <listitem>
      ...
      <itemizedlist>
        <listitem>
          ...
          SVN-20120229,
          Changeset
          <ulink url="&lfs-rev-root;9757">9757</ulink>
          対応。
          </para>
        </listitem>
      </itemizedlist>
    ...
    <listitem>
      <para>2012-02-25</para>
      <itemizedlist>
        <listitem>
          <para>[matsuand] -
          SVN-20120224,
          Changeset
          <ulink url="&lfs-rev-root;9753">9753</ulink>,
          <ulink url="&lfs-rev-root;9754">9754</ulink>,
          <ulink url="&lfs-rev-root;9755">9755</ulink>
          対応。その他整形。
          </para>
        </listitem>
      </itemizedlist>
    ...
    <listitem>
      ...
      <itemizedlist>
        <listitem>
          ...
          SVN-20120219,
          Changeset
          <ulink url="&lfs-rev-root;9748">9748</ulink>
          対応。
          </para>
        </listitem>
      </itemizedlist>
    ...
    <listitem>
      ...
      <itemizedlist>
        <listitem>
          ...
          SVN-20120215,
          Changeset
          <ulink url="&lfs-rev-root;9746">9746</ulink>,
          <ulink url="&lfs-rev-root;9747">9747</ulink>
          対応。
          </para>
        </listitem>
      </itemizedlist>
    ...
    <listitem>
      ...
      <itemizedlist>
        <listitem>
          ...
          SVN-20120214,
          Changeset
          <ulink url="&lfs-rev-root;9744">9744</ulink>,
    ...
    <listitem>
      ...
      <itemizedlist>
        ...
        <listitem>
          ...
          SVN-20120211,
          Changeset
          <ulink url="&lfs-rev-root;9743">9743</ulink>
          対応。
          </para>
        </listitem>
      </itemizedlist>
    ...
    <listitem>
      <para>2012-02-12</para>
      <itemizedlist>
        <listitem>
          <para>[matsuand] -
          SVN-20120211,
          Changeset
          <ulink url="&lfs-rev-root;9740">9740</ulink>,
          <ulink url="&lfs-rev-root;9741">9741</ulink>,
          <ulink url="&lfs-rev-root;9742">9742</ulink>
          対応。
          </para>
        </listitem>
      </itemizedlist>
    ...
    <listitem>
      ...
      <itemizedlist>
        ...
        <listitem>
          <para>[matsuand] -
          変更履歴(日本語版)におけるリビジョンの表記を "Changeset" とする。
          </para>
        </listitem>
      </itemizedlist>
    </listitem>

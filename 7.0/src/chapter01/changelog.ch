...
@y
      ...
      <itemizedlist>
        <listitem>
          <para>[matthew] - Linux-3.1 へのアップグレード。
          <ulink url="&lfs-ticket-root;2937">#2937</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[matthew] - GCC の MPFR 関連の設定パラメーターにて固定パスを取り除く。
          <ulink url="&lfs-ticket-root;2948">#2948</ulink> を Fix に。</para>
        </listitem>
      </itemizedlist>
@z
...
@y
      ...
      <itemizedlist>
        <listitem>
          <para>[bdubbs] - gcc にてロケールに関するいくつかのテストを実施するためのパッチを追加。

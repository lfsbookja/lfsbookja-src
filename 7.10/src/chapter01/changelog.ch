...
@x
      ...
      <itemizedlist>
        <listitem>
          <para>[bdubbs] - Release LFS-7.10.</para>
        </listitem>
      </itemizedlist>
@y
      <para>2016-09-07</para>
...
@y
    ...
    <listitem revision="systemd">
          <para>[bdubbs] - dbus-1.10.10 へのアップデート。
          <ulink url="&lfs-ticket-root;3967">#3967</ulink> を Fix に。</para>
        </listitem> 
      </itemizedlist>
@z
...
@x
      ...
      <itemizedlist>
        ...
        <listitem>
          <para>[bdubbs] - Update to linux-4.7.1. Fixes
          <ulink url="&lfs-ticket-root;3969">#3969</ulink>.</para>
        </listitem>
        <listitem>
          <para>[bdubbs] - Update to gcc-6.2.0. Fixes
          <ulink url="&lfs-ticket-root;3970">#3970</ulink>.</para>
        </listitem>
<!--    <listitem revision="systemd">
...
@y
      ...
      <itemizedlist>
        ...
        <listitem>
          <para>[bdubbs] - linux-4.7.1 へのアップデート。
          <ulink url="&lfs-ticket-root;3969">#3969</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[bdubbs] - gcc-6.2.0 へのアップデート。
          <ulink url="&lfs-ticket-root;3970">#3970</ulink> を Fix に。</para>
        </listitem>
<!--    <listitem revision="systemd">
          <para>[dj] - Update to dbus-1.10.10. Fixes
          <ulink url="&lfs-ticket-root;3967">#3967</ulink>.</para>
...
@y
      ...
      <itemizedlist>
        <listitem>
          <para>[bdubbs] - diffutils-3.4 へのアップデート。
          <ulink url="&lfs-ticket-root;3964">#3964</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[bdubbs] - iproute2-4.7.0 へのアップデート。
          <ulink url="&lfs-ticket-root;3965">#3965</ulink> を Fix に。</para>
        </listitem>
        <listitem>
          <para>[bdubbs] - util-linux 2.28.1 へのアップデート。
          <ulink url="&lfs-ticket-root;3966">#3966</ulink> を Fix に。</para>
        </listitem>
      </itemizedlist>
@z
...
@x
      ...
      <itemizedlist>
        ...
        <listitem>
          ...
          <ulink url="&lfs-ticket-root;3960">#3960</ulink>.</para>
        </listitem>
      </itemizedlist>
@y
      <para>2016-07-29</para>
      <itemizedlist>
        ...
        <listitem>
          ...
          <ulink url="&lfs-ticket-root;3960">#3960</ulink> を Fix に。</para>
        </listitem>
      </itemizedlist>
@z
...
@x
      ...
      <itemizedlist>
        ...
        <listitem>
          <para>[bdubbs] - Update to e2fsprogs-1.43. Fixes
          <ulink url="&lfs-ticket-root;3935">#3935</ulink>.</para>
        </listitem>
        <listitem>
          <para>[bdubbs] - Update to gdbm-1.12. Fixes
          <ulink url="&lfs-ticket-root;3933">#3933</ulink>.</para>
        </listitem>
        <listitem>
          <para>[bdubbs] - Update to iproute2-4.6.0. Fixes
          <ulink url="&lfs-ticket-root;3934">#3934</ulink>.</para>
        </listitem>
        <listitem>
          <para>[bdubbs] - Update to make-4.2. Fixes
...
@x
      ...
      <itemizedlist>
        <listitem>
          <para>[dj] - Add additional explanatory text for systemctl and
...
@y
      ...
      <itemizedlist>
        <listitem>
          <para>[dj] - systemctl コマンドと journalctl コマンドについて記述追加。</para>
        </listitem>
     </itemizedlist>
@z

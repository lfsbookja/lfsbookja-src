...
@y
    <para arch="default">
    x86_64 上でビルドしている場合は、64 ビットライブラリのデフォルトディレクトリ名を<quote>lib</quote>にします。
    </para>
@z
...
@y
    ...
    64 ビットライブラリのデフォルトディレクトリ名を<quote>lib</quote>にします。
    </para>
@z
...
@y
    <para arch="ml_32,ml_x32,ml_all">
    GCC を初めてビルドする際には GMP、ISL、MPFR、MPC の各パッケージを必要とします。
    tarball を解凍して、所定のディレクトリ名に移動させます。
    </para>
@z

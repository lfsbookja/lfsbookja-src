...
@y
    <title>&InstallationOf1;systemd - 32 ビット&InstallationOf2;</title>
@z
...
@y
    <para>
    xsltproc がなくても動作するように、シンボリックリンクを生成します。
    </para>
@z
...
@y
    <para>
    まだ Util-Linux の最終版はインストールしていないため、現在あるライブラリに対してのリンクを生成します。
    </para>
@z
...
@y
    <title>&InstallationOf1;systemd - x32 ビット&InstallationOf2;</title>
@z

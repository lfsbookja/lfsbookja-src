...
@y
    <title>&InstallationOf1;Expat - 32 ビット&InstallationOf2;</title>
@z
...
@y
    <para>
    上のビルド結果をいったんきれいにしますが、コンパイル済のドキュメントだけは残すようにします。
    この段階では再ビルドできないためです。
    </para>
@z
...
@y
    <title>&InstallationOf1;Expat - x32 ビット&InstallationOf2;</title>
@z

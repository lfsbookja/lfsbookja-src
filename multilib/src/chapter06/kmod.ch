...
@y
    <title>&InstallationOf1;Kmod - 32 ビット&InstallationOf2;</title>
@z
...
@y
    ...
    上のビルド結果をいったんきれいにします。
    ただし man ページだけは残します。
    この時点においては、まだ xsltproc がインストールされていないため man ページを再作成できないからです。
    </para>
@z
...
@y
    <title>&InstallationOf1;Kmod - x32 ビット&InstallationOf2;</title>
@z

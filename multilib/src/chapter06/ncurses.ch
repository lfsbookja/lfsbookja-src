...
@x "ml_32,ml_x32,ml_all" --with-pkg-config-libdir=/usr/lib/pkgconfig
...
@y
          <para>
          本スイッチは .pc ファイルを /usr/lib/pkgconfig にインストールするようにします。
          これを定義しておかないと、64 ビットバイナリに対しての .pc ファイルが /usr/lib32 にインストールされてしまうためです。
          </para>
@z
...
@y
    <title>&InstallationOf1;Ncurses - 32 ビット&InstallationOf2;</title>
@z
...
@y
    <title>&InstallationOf1;Ncurses - x32 ビット&InstallationOf2;</title>
@z
